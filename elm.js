...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var awesomeStyle = function (profile) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                             ,_0: "paddingLeft"
                                             ,_1: "10px"}
                                            ,{ctor: "_Tuple2",_0: "marginRight",_1: "10px"}
                                            ,{ctor: "_Tuple2",_0: "width",_1: "60px"}
                                            ,{ctor: "_Tuple2",_0: "backgroundColor",_1: profile.color}]));
   };
   var awesomeHtml = function (profile) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.span,
              _U.list([awesomeStyle(profile)]),
              _U.list([]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "fontSize"
                                                       ,_1: "20px"}]))]),
              _U.list([$Html.text(profile.name)]))]));
   };
   ...
   var profileHtml = function (profile) {
      return A2($Html.div,
      _U.list([colorStyle(profile.color)]),
      _U.list([$Html.text(profile.name)]));
   };
   var profileData = _U.list([{ctor: "_Tuple2"
                              ,_0: "Nick"
                              ,_1: "red"}
                             ,{ctor: "_Tuple2",_0: "Adam",_1: "green"}
                             ,{ctor: "_Tuple2",_0: "Alice",_1: "yellow"}
                             ,{ctor: "_Tuple2",_0: "Jess",_1: "orange"}]);
   var createProfile = function (_p0) {
      var _p1 = _p0;
      return {name: _p1._0,color: _p1._1};
   };
   var profiles = A2($List.map,createProfile,profileData);
   var main = A2($Html.div,
   _U.list([]),
   A2($List.map,profileHtml,profiles));
   var Profile = F2(function (a,b) {
